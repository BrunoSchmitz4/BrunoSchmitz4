...
<div>
  ...
  <p>🖥️ <b>Using nowadays:</b> React JS, Git tools (Git, Github and Github desktop), Javascript, C#, Java, MySQL and Figma (These are just the main ones);</p>
  <p>🔄 <b>Already Used:</b> Node JS, TS, BootStrap, Angular, PLSQL(MySQL)</p>
